...
//    'Back' => 'back',
    ...
    'Upload_base' => 'Upload thông thường',
        'Upload_base_help' => "Kéo & Thả tệp hoặc nhấp vào nút phía trên để Chọn file và nhấp vào Bắt đầu tải lên. Khi quá trình tải lên hoàn tất, hãy nhấp vào nút 'Quay lại danh sách tệp'.",
    'Upload_add_files' => 'Chọn file',
