 ...
 * Chinh them
 */
$multiple_selection = isset($_GET['multiple_selection']) && $_GET['multiple_selection'] == 'false' ? false : true;
$_SESSION['RF']['language'] = 'vi';
//set_permission();
//
...
//            if (!file_exists("admin/$admin->id")) {
//                mkdir("admin/$admin->id", 0777, true);
//            }
//            $_SESSION["RF"]["subfolder"] ="admin/$admin->id/";
//        }
//    }catch (Exception $e){}
//}
...
//    'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://". @$_SERVER['HTTP_HOST'],
    ...
    |
    */
//    'upload_dir' => '/system/filemanager/upload/',
    'upload_dir' => '/uploads/',
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
//    'current_path' => '../../filemanager/upload/',
...
//    'thumbs_base_path' => '../../filemanager/thumbs/',
    ...
    */
    'multiple_selection' => $multiple_selection ?? true,
    ...
    |
     */
    'multiple_selection_action_button' => $multiple_selection ?? true,
