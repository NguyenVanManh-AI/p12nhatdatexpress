        jQuery(document).ready(function() {
            ...
            $(".item-account").click(function() {
                ...
                $(this)
                    ...
                    .toggleClass("remove");
                var menu = $(this).children(".item-account-parent");
                menu.find(".fa-chevron-right").toggleClass("remove");
                menu.find(".fa-chevron-down").toggleClass("active");
            });
...
//            });
            ...
            // should change?
            $(window).scroll(function() {
                var he = $('.main').outerHeight();
                var hetop = $('.header-account-business').outerHeight();
                var height5 = $('.manager-content').outerHeight();
                var widget = $('.widget.widget-account').outerHeight();
                if (height5 >= widget+300 && $(window).width() >= 1200) {
                $(".content-left-account").addClass("top");
                if ($(window).scrollTop() >= he+hetop-widget) {
                    $(".content-left-account").removeClass("top");
                   $(".content-left-account").addClass('scroll');
                   $(".widget.widget-account").addClass('scroll');
                }else if($(window).scrollTop() < he+hetop-widget){
                    $(".content-left-account.scroll").removeClass('scroll');
                    $(".widget.widget-account.scroll").removeClass('scroll');
                    $(".content-left-account").addClass("top");
                }
                }else{
                    if ($(window).scrollTop() >= he+hetop-100){
                        $(".content-left-account").css({"top" : "0" , "height" : "100%"});
                    }else{
                        var hetop = $('.header-account-business').outerHeight();
                         $(".content-left-account").css({"top" : hetop , "height" : "calc(100% - "+hetop+"px)"});
                    }
                }
            });
        });
