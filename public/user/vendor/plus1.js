jQuery(document).ready(function($) {
    ...
    function adsProfile() {
        let adsLeft = $(".ads-page-profile .ads-left"),
            adsRight = $(".ads-page-profile .ads-right"),
            ads = $(".ads-page-profile"),
        ...
        $(window).bind("scroll", function() {
            ...
            if (top >= positions) {
                $(".ads-page-profile.ads-fixed").css({
                    top: positions + "px",
                    position: "absolute",
                });
            } else {
                $(".ads-page-profile.ads-fixed").css({ top: "5px", position: "fixed" });
            }
        });
