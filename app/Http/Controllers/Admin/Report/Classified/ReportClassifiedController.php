...
class ReportClassifiedController extends Controller
{
    ...
    public function list(Request $request){
        ...
        return view('Admin.Report.Classified.report',compact('list','report_group'));
    }
    ...
    public function unblock_display($id){
        ...
        // Helper::create_admin_log(38,$data);
