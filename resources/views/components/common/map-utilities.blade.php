<div class="map-utilities__list {{ $attributes['class'] ?: 'px-2 pb-2' }}">
  <button
    class="map-utilities__item mr-2 mt-2 position-relative btn btn-sm btn-outline-secondary pl-5"
    data-value="Siêu+thị"
    data-types="supermarket,shopping_mall"
    data-icon="{{ asset('images/icons/map/supermarket-marker.png') }}"
  >
    <span class="map-utilities__item-icon text-success border-right border-dark position-absolute start-0 top-0 h-100 flex-center">
  ...
  >
    <span class="map-utilities__item-icon text-primary border-right border-dark position-absolute start-0 top-0 h-100 flex-center">
  ...
  >
    <span class="map-utilities__item-icon text-warning border-right border-dark position-absolute start-0 top-0 h-100 flex-center">
  ...
  >
    <span class="map-utilities__item-icon text-danger border-right border-dark position-absolute start-0 top-0 h-100 flex-center">
