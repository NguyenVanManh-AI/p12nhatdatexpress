{{-- old code --}}
<div class="section fengshui mb-4">
    ...
    @if($list->count() > 0)
        <div class="row">
        <div class="col-md-7 mb-sm-0 mb-3">
            <div class="image-ratio-box-75 relative">
                <a
                  class="absolute-full"
        ...
        <div class="col-md-5">
            <div class="fengshui-right fengshui-right-box__list">
                @foreach($list as $item)
                    <div class="fengshui-right-box__item d-flex {{ $loop->index + 1 < count($list) ? 'mb-3' : '' }}">
                        <div class="image-ratio-box-75 w-size-105 relative">
                            <a
                              class="absolute-full"
                        ...
                        <div class="fengshui-right-box__item-detail d-flex flex-column justify-content-between flex-1 px-2 pt-2 pb-0">
                            <h3 class="title">
                                <a class="text-ellipsis ellipsis-2 fs-14 link-dark"
                                    href="{{ route('home.focus.detail', [data_get($item->group, 'group_url'), $item->news_url]) }}">
                                    {{ $item->news_title }}
                                </a>
                            </h3>
