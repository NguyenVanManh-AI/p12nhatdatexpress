    ...
    <div class="tab-content" id="v-pills-tabContent">
        <div class="">
            <div class="list-mail bg-white">
                ...
                <form id="formtrash" action="{{route('admin.mailbox.untrashlist')}}" method="POST">
                    @csrf
                    ...
                    @endif
                    @if($list->count()==0 && isset($_GET['null']))
        ...
        <div class="table-bottom d-flex align-items-center justify-content-between mb-4  pb-5">
            <div class="text-left d-flex align-items-center">
                <div class="manipulation d-flex mr-4">
                    ...
                    <div class="btn-group ml-1">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item trash_list unToTrash"  href="javascript:{}">
                ...
                <div class="display d-flex align-items-center ">
                    <span>Hiển thị:</span>
                    <form method="get" action="{{route('admin.mailbox.trash')}}">
