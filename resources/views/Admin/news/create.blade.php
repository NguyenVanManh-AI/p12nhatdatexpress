    ...
    <form action="{{ route('admin.news.store') }}" method="post" enctype="multipart/form-data">
      ...
      <div class="row m-0 px-2 pb-3">
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-2">
          <div class="row">
            <div class="col-12 pb-3">
              ...
              <input value="{{ old('news_title') }}" id="news_title" class="form-control" type="text"
                name="news_title">
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-2">
          ...
          <input value="{{ old('meta_key') }}" class="seo form-control" type="text" id="meta_key"
            name="meta_key" placeholder="Nhập từ khóa ...">
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-2">
          <label>Tiêu đề <span class="required"></span></label>
          <input value="{{ old('meta_title') }}" class="seo form-control meta_title" type="text" name="meta_title"
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-2">
          ...
          <input value="{{ old('meta_url') }}" class="seo form-control meta_url" type="text" name="meta_url"
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-2">
          ...
          <input value="{{ old('meta_desc') }}" class="seo form-control" type="text" id="meta_desc"
            name="meta_desc" placeholder="Nhập mô tả ...">
