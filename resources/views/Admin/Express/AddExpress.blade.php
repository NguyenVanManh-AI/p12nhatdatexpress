...
@section('Title', 'Tạo chiến dịch | Quảng cáo express')
@section('Style')
...
@section('Content')
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12 text-left">
                    <h4 class="m-0 font-weight-bold text-uppercase">Thêm chiến dịch</h4>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <form method="post" action="{{route('admin.express.store')}}">
                        @csrf
                        <div class="row">
