...
{{--            @endif--}}
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12 text-left">
                    <h4 class="m-0 font-weight-bold text-uppercase">Sửa banner quảng cáo express</h4>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <form method="post" action="{{route('admin.express.update', $item->id)}}">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group">
                                            <label for="banner_title">Tên chiến dịch <span class="font-weight-bold text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-2">
                                <label>Ảnh <span class="font-weight-bold text-danger">*</span></label>
                                <br>
