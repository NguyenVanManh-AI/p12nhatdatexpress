  ...
  <div class="container-fluid">
    <div class="row">
                ...
                <td>
                  <div class="flex-column">
                    <x-admin.restore-button
                      ...
                      url="{{ route('admin.comment.project.restore-multiple', ['ids' => $item->id]) }}"
                    />
  
                    <x-admin.force-delete-button
                      :check-role="$check_role"
                      url="{{ route('admin.comment.project.force-delete-multiple', ['ids' => $item->id]) }}"
                    />
                  </div>
                </td>
              </tr>
      ...
      <x-admin.table-footer
        :check-role="$check_role"
        :lists="$list"
        force-delete-url="{{ route('admin.comment.project.force-delete-multiple') }}"
        restore-url="{{ route('admin.comment.project.restore-multiple') }}"
      />
  </div>
</div>
</div>
