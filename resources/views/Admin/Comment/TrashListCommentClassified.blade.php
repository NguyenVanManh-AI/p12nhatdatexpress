  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-12">
        <div class="table-responsive">
          <form action="{{route('admin.comment.untrashlist-comment-classified')}}" id="formtrash" method="post">
            @csrf
              ...
              <td class="text-left">
                <div>
                  ...
                  <x-admin.force-delete-button
                    ...
                    id="{{ $item->id }}"
                    url="{{ route('admin.comment.list-classified-force-delete-multiple') }}"
                  />
                </div>
              </td>
            </tr>
    ...
    <div class="table-bottom d-flex align-items-center justify-content-between mb-4  pb-5">
      ...
      <div>
        ...
        <a href="{{route('admin.comment.list-classified')}}" class="btn btn-primary">
          Quay lại
        </a>
        @endif
      </div>
  ...
  $('.delete').click(function () {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location.href = "/admin/comment/classified/undelete/" + id+"/"+created_by;
