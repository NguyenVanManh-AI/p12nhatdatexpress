...
@section('Title', 'Bình luận báo cáo | Bài viết')
@section('Style')
<style type="text/css">
             ...
             <tbody>
              ...
              <tr>
                ...
                <td class="py-2 px-0">
                  ...
                  @if($check_role == 1  ||key_exists(2, $check_role))
                  @if( $ListComment->is_locked== 1 && $ListComment->is_forbidden ==0)
                  @if($ListComment->is_locked == 1)
                  @if($check_role == 1  ||key_exists(2, $check_role))
                  <div class="float-left ml-2 cusor-point mb-1">
                    <i class="icon-setup fa fa-times mr-2 "></i>
...
<script type="text/javascript">
  ...
  $('.wrong').click(function () {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location.href = "/admin/comment/user-post/wrong-report-comment-post/" + id + "/" + created_by;
      }
    });
  });
  ...
  $('.blockAccount').click(function () {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location.href = "/admin/comment/user-post/lock-unlock-account-post/" + id + "/" + created_by;
      }
    });
  });
  ...
  $('.forbidden-list').click(function () {
    $('#formtrash').attr('action', "/admin/comment/user-post/forbidden-account-list")
    var id = $(this).data('id');
    Swal.fire({
  ...
  $('.un-forbidden-list').click(function () {
    $('#formtrash').attr('action', "/admin/comment/user-post/un-forbidden-account-list")
    var id = $(this).data('id');
    Swal.fire({
  ...
  $('.wrong-list').click(function () {
    $('#formtrash').attr('action', "/admin/comment/user-post/wrong-report-comment-post-list")
    var id = $(this).data('id');
    Swal.fire({
  ...
  $('.locked-list').click(function () {
    $('#formtrash').attr('action', "/admin/comment/user-post/locked-account-list")
    var id = $(this).data('id');
    Swal.fire({
  ...
  $('.unlocked-list').click(function () {
    $('#formtrash').attr('action', "/admin/comment/user-post/un-locked-account-list")
    var id = $(this).data('id');
    Swal.fire({
      title: 'Chặn nhiều tài khoản',
      text: "Các tài khoản đã được chọn sẽ bị chuyển sang trạng thái chặn",
