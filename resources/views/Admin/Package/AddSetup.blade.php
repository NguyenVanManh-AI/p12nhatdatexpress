...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="block-dashed">
            <h3 class="title">Thêm gói tin</h3>
            <div class="form-group col-md-4">
            </div>
            <form action="{{route('admin.setup.add')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <label for="">Tên gói tin</label>
                        <input  type="text" name="package_name" class="form-control" placeholder="Tên gói tin" value="{{old('package_name')}}">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <select name="package_type" class="custom-select">
                         ...
                         <option value="D" {{ old('package_type') == 'D' ? 'selected' : ''}}>Mặc định</option>
                         <option value="V" {{ old('package_type') == 'V' ? 'selected' : ''}}>Gói víp</option>
                         <option value="A" {{ old('package_type') == 'A' ? 'selected' : ''}}>Nâng cao</option>
                     </select>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="duration_time" class="custom-select">
                            ...
                            <option value="{{7*24*60*60}}" {{ old('duration_time') == 24*60*60? 'selected' : ''}}>Một tuần</option>
                            <option value="{{(24*60*60)}}" {{ old('duration_time') == 7*24*60*60? 'selected' : ''}}>Một ngày</option>
                            <option value="{{30*24*60*60}}" {{ old('duration_time') == 30*24*60*60? 'selected' : ''}}>Một tháng</option>
                            <option value="{{365*24*60*60}}" {{ old('duration_time') ==  365*24*60*60? 'selected' : ''}}>Một năm</option>
                        </select>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input value="{{old('price')}}" type="text" name="price" class="form-control" placeholder="Giá thường">
                        @if($errors->has('price'))
                        <small  class="text-danger">
                            {{$errors->first('price')}}
                        </small>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input value="{{old('discount_price')}}" type="text" name="discount_price" class="form-control" placeholder="Giá khuyến mãi">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input value="{{old('classified_nomal_amount')}}" type="text" name="classified_nomal_amount" class="form-control" placeholder="Số tin thường">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input value="{{old('vip_amount')}}" type="text" name="vip_amount" class="form-control" placeholder="Số tin vip">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input value="{{old('highlight_amount')}}" type="text" name="highlight_amount" class="form-control" placeholder="Số tin nổi bật">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input value="{{old('classified_per_day')}}" type="text" name="classified_per_day" class="form-control" placeholder="Số tin thường trong ngày">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="vip_duration" class="custom-select">
                            ...
                            <option value="{{(24*60*60)}}" {{ old('vip_duration') == 24*60*60 ? 'selected' : ''}}>Một ngày</option>
                            <option value="{{7*24*60*60}}" {{ old('vip_duration') == 7*24*60*60? 'selected' : ''}}>Một tuần</option>
                            <option value="{{30*24*60*60}}" {{ old('vip_duration') == 30*24*60*60 ? 'selected' : ''}}>Một tháng</option>
                            <option value="{{365*24*60*60}}" {{ old('vip_duration') == 365*24*60*60 ? 'selected' : ''}}>Một năm</option>
                        </select>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="highlight_duration" class="custom-select">
                            ...
                            <option  value="{{(24*60*60)}}" {{ old('highlight_duration') == 24*60*60 ? 'selected' : ''}}>Một ngày</option>
                            <option value="{{7*24*60*60}}" {{ old('highlight_duration') == 7*24*60*60? 'selected' : ''}}>Một tuần</option>
                            <option value="{{30*24*60*60}}" {{ old('highlight_duration') == 30*24*60*60 ? 'selected' : ''}}>Một tháng</option>
                            <option value="{{365*24*60*60}}" {{ old('highlight_duration') == 365*24*60*60 ? 'selected' : ''}}>Một năm</option>
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <input type="checkbox" {{old('cus_mana')?"checked":""}} name="cus_mana">
                        <label for="">Quản lý khách hàng</label>
                    </div>

                    <div class="form-group col-md-4">
                        <input type="checkbox" {{old('data_static')?"checked":""}} name="data_static">
                        <label for="">Thống kê dữ liệu</label>
                    </div>

                    <div class="form-group col-md-4">
                        <input type="checkbox" value="1" {{ old('best_seller') ? 'checked' : '' }} name="best_seller">
            ...
            <div class="text-center">
                <div class="preview">
                    <img style="max-width: 200px; display: none; margin-bottom: 30px" id="previewImg" src="" alt="preview image" class="img-fluid"/>
                </div>
                ...
                @endif
                 ...
                 <div class="upload-avatar btn bg-blue-light" data-toggle="modal" data-target="#modalFile">
                    ...
                    <input type="hidden" name="qr_image" id="qr_image" autocomplete="off">
                </div>
