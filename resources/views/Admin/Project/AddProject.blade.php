...
@section('Content')
    ...
    <div class="bg-white box-main-reponsive box-main">
        <form id="form" action="{{route('admin.project.store')}}" method="post" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="row">
                <div class="box-input-reponsive col-sm-12 col-md-6 box-info-left-top pr-4" style="height: initial">
                    ...
                    <input class="form-control required" type="text" name="project_name" placeholder="Khu đô thị mới Thuận Phước"
                           id="project_name" onblur="changeToSlug(this, '#project_url')" value="{{old('project_name')}}">
                    ...
                    <div class="box-dash">
                        ...
                        <div class="row pt-2 pr-3">
                            ...
                            <div class="col-12 col-sm-12 col-md-4 col-lg-3 select-box mtdow10">
                                ...
                                <br>
                                <input class="form-control required" placeholder="" name="investor" value="{{old('investor')}}"/>
...
{{--                    <br />--}}
            ...
            <div class="px-2">
                ...
                <div class="box-seo-main-reponsive row mt-4 mb-5">
                    ...
                    <div class="box-seo-reponsive tach-input col-12 col-sm-12 col-md-6 col-lg-6 box_input p-0 pr-2"
                          >
        ...
        @section('Script')
            ...
            <script type="text/javascript">
                ...
                async function callbackMarkerToAddress(result){
                    ...
                    await sleep(500)
                    if (!district['district'] || !district['district'].id)return
                ...
                $(document).ready(function () {
                    ...
                    get_district('#province_id', '{{route('param.get_district')}}', '#district', {{old('province_id') ?? "null"}}, {{old('district_id') ?? "null"}})
                    get_ward('#district_id', '{{route('param.get_ward')}}', '#ward', {{old('district_id') ?? "null"}} , {{old('ward_id') ?? "null"}})
