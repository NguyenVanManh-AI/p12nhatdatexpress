    ...
    <div class="col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4 p-3 mb-4 cusor-point">
      <div>
        <a href="{{route('admin.project.update-price')}}">
          <img src="{{ asset("system/images/icons/update3.png")}}" width="100%" height="100%" style="border: 5px solid #007bff;border-radius: 50%">
        </a>
...
<script type="text/javascript">
  ...
  $('.confirm').click(function () {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location.href = "/admin/project/update-manage/confirm-update-price/" + id + "/" + index;
      }
    });
  });
  $('.recover').click(function () {
    ...
    Swal.fire({
      title: 'Hoàn tác',
      text: "Khi hoàn tác, Giá sẽ được đưa về lúc chưa cập nhật",
      icon: 'warning',
      showCancelButton: true,
      confirmButtonColor: '#d33',
      cancelButtonColor: '#3085d6',
      ...
      if (result.isConfirmed) {
        window.location.href = "/admin/project/update-manage/recover-update-price/" + id + "/" + index;
      }
    });
  });
</script>
