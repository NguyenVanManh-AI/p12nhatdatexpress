...
{{--                            <input name="created_at[date_start]" class="form-control float-right" type="date" value="{{$date_start ?? ""}}" />--}}
...
{{--                        <input name="created_at[date_end]" class="form-control float-right" type="date" value="{{$date_end ?? ""}}" />--}}
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12 text-center">
                    <h4 class="m-0 font-weight-bold">QUẢN LÝ THÙNG RÁC NHÓM TRANG</h4>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                            ...
                            <form action="{{route('admin.static.group.action')}}" id="formAction" method="post">
                                ...
                                @forelse($group_page as $item)
                                    <tr>
                                        ...
                                        <td class="title_role" style="word-break: break-word">{{$item->group_title}}</td>
                                        <td>
...
{{--                                                @endif--}}
                    ...
                    <div class="d-flex align-items-center justify-content-between my-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <a class="btn btn-primary" type="button" href="{{route('admin.static.group')}}">Quay lại</a>
                            </div>
                        </div>
                        <div class="d-flex align-items-center">
    ...
    <script>
        function deleteItem(id, created)
        {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href= `{{route('admin.static.group.force-delete', ['',''])}}/${id}/${created}`;
                }
            })
        }
        function restoreItem(id, created)
        {
            Swal.fire({
                ...
                if (e.value) {
                    window.location.href= `{{route('admin.static.group.restore', ['',''])}}/${id}/${created}`;
                } else {
                    e.dismiss;
                }
            })
