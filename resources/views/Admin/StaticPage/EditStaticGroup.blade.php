...
@section('Content')
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12 text-left">
                    <h4 class="m-0 font-weight-bold text-uppercase">Sửa nhóm trang tĩnh</h4>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <form method="post" action="{{route('admin.static.group.update', [$page_group->id, \Crypt::encryptString($page_group->created_by)])}}">
                        @csrf
                        <div class="row">
                            <div class="col-lg-8 col-md-12">
                                <div class="form-group">
                                    <label for="group_title">Tiêu đề <span class="font-weight-bold text-danger">*</span></label>
                                    <input type="text" name="group_title" class="form-control" id="group_title" value="{{ (old('group_title')) ?? $page_group->group_title}}">
                            ...
                            <div class="col-lg-4 col-md-12">
                                ...
                                <select class="form-control select2 w-100" name="parent_id">
                                    ...
                                    @foreach($parent_group as $group)
                                        <option value="{{$group->id}}" {{ old('parent_id') == $group->id || $page_group->parent_id == $group->id ? "selected" : ""}}>{{$group->group_title}}</option>
                                    @endforeach
                                </select>
                                ...
                                <div class="row mt-3">
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="group_url" class="form-control input-seo" id="group_url" value="{{ (old('group_url')) ?? $page_group->group_url}}">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="meta_title" class="form-control input-seo" id="meta_title" value="{{ (old('meta_title')) ?? $page_group->meta_title}}">
                                ...
                                <div class="row mt-1">
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control input-seo" name="meta_keyword" id="meta_keyword" rows="3">{{ (old('meta_keyword')) ?? $page_group->meta_keyword}}</textarea>
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control input-seo" name="meta_description" id="meta_description" rows="3">{{ (old('meta_description')) ?? $page_group->meta_description}}</textarea>
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="image_url" name="image_url" value="{{old('image_url') ?? $page_group->image_url}}">
