...
@section('Content')
        ...
        <ol class="breadcrumb mt-1 align-items-center">
            ...
            @if($check_role == 1  ||key_exists(1, $check_role))
                ...
                <li class="add px-2 ml-1 p-1">
                    <a href="{{route('admin.static.page.add')}}">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12 text-left">
                    <h4 class="m-0 font-weight-bold text-uppercase">sửa trang tĩnh</h4>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <form method="post" action="{{route('admin.static.page.update', [$item->id, \Crypt::encryptString($item->created_by)])}}">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <label for="page_title">Tiêu đề <span class="font-weight-bold text-danger">*</span></label>
                                    <input type="text" name="page_title" class="form-control" id="page_title" value="{{ (old('page_title')) ?? $item->page_title}}">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <textarea class="js-admin-tiny-textarea" name="page_description" id="page_description">{{ (old('page_description')) ?? $item->page_description}}</textarea>
                                ...
                                <div class="row mt-4">
                                    <div class="col-12">
                                        ...
                                        <textarea class="js-admin-tiny-textarea" name="page_content" id="page_content">{{ (old('page_content')) ?? $item->page_content}}</textarea>
                                ...
                                <div class="row mt-4">
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="page_url" class="form-control input-seo" id="page_url" value="{{ (old('page_url')) ?? $item->page_url}}">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="meta_title" class="form-control input-seo" id="meta_title" value="{{ (old('meta_title')) ?? $item->meta_title}}">
                                ...
                                <div class="row mt-1">
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control input-seo" name="meta_key" id="meta_key" rows="3">{{ (old('meta_key')) ?? $item->meta_key}}</textarea>
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control input-seo" name="meta_desc" id="meta_desc" rows="3">{{ (old('meta_desc')) ?? $item->meta_desc}}</textarea>
...
{{--                                                <option value="{{$group->id}}" {{ old('page_group') == $group->id || $item->page_group == $group->id ? "selected" : "" }}>{{$group->group_title}}</option>--}}
{{--                                            @endforeach--}}
{{--                                        </select>--}}
{{--                                    </div>--}}
...
{{--                                                </label>--}}
{{--                                            </div>--}}
{{--                                            <input type="text" class="form-control" id="image_url" name="image_url" value="{{old('image_url') ?? $item->image_url}}">--}}
