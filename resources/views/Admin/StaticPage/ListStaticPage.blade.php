...
{{--                        <option selected="selected" value="" disabled>Nhóm</option>--}}
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12 text-center">
                    <h4 class="m-0 font-weight-bold text-uppercase">QUẢN LÝ TRANG TĨNH</h4>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
...
{{--                                            <div>--}}
{{--                                                <label class="mr-2">--}}
{{--                                                    <input class="checkboxItem" id="is_highlight_{{$item->id}}" type="checkbox" value="1" name="is_highlight[{{$item->id}}]" {{ (old('is_highlight')) == 1 || $item->is_highlight == 1 ? "checked" : ""}} >--}}
{{--                                                </label>--}}
...
{{--                                            </div>--}}
                                        ...
                                        <td class="text-left">
                                            <div class="table_action">
                                                ...
                                                <div class="ml-3 mb-2">
                                                    <i class="fas fa-copy mr-2" style="padding-right: 5px"></i>
                            ...
                            @if($check_role == 1 || key_exists(8, $check_role))
                                <div class="d-flex flex-row align-items-center view-trash">
                                    ...
                                    <div class="link-custom">
                                        <a href="{{route('admin.static.page.trash')}}"><span style="color: #347ab6">Xem thùng rác</span>
    ...
    <script>
        function deleteItem(id, created)
        {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href= `{{route('admin.static.page.delete', ['',''])}}/${id}/${created}`;
                }
            })
        }
        function duplicateItem(id, created)
        {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href= `{{route('admin.static.page.duplicate', ['',''])}}/${id}/${created}`;
                }
            })
        }
