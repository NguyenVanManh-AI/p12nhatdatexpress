...
@section('Title', 'Thêm mẫu email | Chiến dịch email')
@section('Style')
...
<section>
    <div>
        ...
        <h4 class="text-center font-weight-bold mb-0 mt-2">THÊM MẪU MAIL</h4>
        <div class="px-2">
            @if($check_role == 1  || key_exists(1, $check_role))
                <form id="add-mail-template" action="{{route('admin.email-campaign.post-add-mail-template')}}"
                    ...
                    <div class="row m-0 pb-3">
                        <div id="campent-box" class="col-12 col-sm-12 col-md-12 col-lg-12 p-0">
                            <div class="col-12  p-2">
                                ...
                                <input class="form-control required" type="text" name="template_title"
                                       placeholder="Xin chào %ten_nguoi_nhan%">
                            </div>
                            <div class="col-12 p-2 pdx8i">
                                <label class="float-left">Nội dung</label>
                                <textarea class="js-admin-tiny-textarea" name="template_content" style="width: 100%;height: 300px">{{ (old('template_content')) ?? ""}}</textarea>
