    ...
    <div class="row">
      <div class="col-12">
        <div class="table-responsive">
          <form action="{{route('admin.email-campaign.delete-mail-config-list')}}" id="formtrash" method="post">
            @csrf
      ...
      <div class="table-bottom d-flex align-items-center justify-content-between  pb-5" style="margin-bottom: 90px !important">
        ...
        <div class="d-flex flex-row align-items-center view-trash" style="margin-top: -5px">
          ...
          <div class="link-custom" >
            <a href="{{route('admin.email-campaign.trash-list-mail-config')}}"><span  style="color: #347ab6">Xem thùng rác</span>
  ...
  $('.delete').click(function () {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        window.location.href = "/admin/mail-campaign/config/delete-mail-config/" + id + "/" + created_by;
      }
    });
  });
  //----------------------------------------------thao tác list
