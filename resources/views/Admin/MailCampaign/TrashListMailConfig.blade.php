...
<section class="content hiden-scroll">
  <div class="container-fluid">
    <div class="row">
      <div class="col-12">
        <div class="table-responsive">
          <form action="{{route('admin.email-campaign.un-delete-mail-config-list')}}" id="formtrash" method="post">
            @csrf
                ...
                <td class="text-left">
                  <div>
                    ...
                    <x-admin.force-delete-button
                      ...
                      id="{{ $item->id }}"
                      url="{{ route('admin.email-campaign.mail-config-force-delete-multiple') }}"
                    />
                  </div>
                </td>
              </tr>
    ...
    <div>
     ...
     <a href="{{route('admin.email-campaign.list-mail-config')}}" class="btn btn-primary">
      Quay lại
    </a>
    @endif
  </div>
  ...
  $('.delete').click(function () {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        window.location.href = "/admin/mail-campaign/config/un-delete-mail-config/" + id+"/"+created_by;
