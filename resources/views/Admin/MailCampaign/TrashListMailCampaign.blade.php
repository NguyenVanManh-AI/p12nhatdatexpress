    ...
    <div class="row">
      <div class="col-12">
        <div class="table-responsive">
          <form action="{{route('admin.email-campaign.un-delete-mail-campaign-list')}}" id="formtrash" method="post">
            @csrf
                ...
                <td class="text-left">
                  <div>
                    ...
                    <x-admin.force-delete-button
                      ...
                      id="{{ $item->id }}"
                      url="{{ route('admin.email-campaign.mail-campaign-force-delete-multiple') }}"
                    />
                  </div>
                </td>
              </tr>
      ...
      <div>
       ...
       <a href="{{route('admin.email-campaign.list-campaign')}}" class="btn btn-primary">
        Quay lại
      </a>
      @endif
    </div>
