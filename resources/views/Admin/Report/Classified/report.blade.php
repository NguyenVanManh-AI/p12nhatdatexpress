...
@section('Title', 'Báo cáo | Nội dung tin rao')
@section('Content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <table class="table">
                ...
                <tbody>
                <form action="{{route('admin.report.classified.list_action')}}" id="list_action" method="post">
                    @csrf
...
{{--                                @if($check_role == 1  ||key_exists(2, $check_role))--}}
                                    @if(!$item->user->isForbidden())
                                        ...
                                        <a href="javascript:{}" class=" forbidden ban text-red ml-3 mb-2" data-id="{{$item->user_id}}"> Cấm tài khoản</a>
                                        </div>
                                    @else
                                        <div class=" mb-1">
                                            <i class="fas fa-undo-alt"></i>
                                            <a href="javascript:{}" class=" unforbidden ml-3 text-primary mb-2" data-id="{{$item->user_id}}"> Bỏ cấm tài khoản</a>
                                        </div>
                                    @endif
{{--                                @endif--}}
{{--                                @if($check_role == 1  ||key_exists(2, $check_role))--}}
                                    @if($item->user->is_deleted==0)
                                        ...
                                        <a href="javascript:{}" class="ml-1 delete_account ml-3 text-red mb-2"  data-id="{{$item->user_id}}"> Xóa tài khoản</a>
                                        </div>
                                    @else
                                        <div class=" mb-1">
                                            <i class="fas fa-undo-alt"></i>
                                            <a href="javascript:{}" class="ml-1 restore_account ml-3 text-primary mb-2"  data-id="{{$item->user_id}}"> Khôi phục tài khoản</a>
                                        </div>
                                    @endif
                                    @endif
                                @endif
            ...
            <div class="table-bottom d-flex align-items-center justify-content-between mb-4">
                <div class="text-left d-flex align-items-center">
                    ...
                    <div class="display d-flex align-items-center mr-4">
                        <span>Hiển thị:</span>
                        <form method="get" id="paginateform" action="{{route('admin.report.classified.list')}}">
    ...
    <script>
        ...
        $('.report_false').click(function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "/admin/report/classified/report-false/" + id;
        ...
        $('.block_display').click(function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "/admin/report/classified/block/" + id;
        ...
        $('.unblock_display').click(function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "/admin/report/classified/unblock/" + id;
        ...
        $('.block_account').click(function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "/admin/report/classified/block-account/" + id;
        ...
        $('.unblock_account').click(function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "/admin/report/classified/unblock-account/" + id;
        ...
        $('.forbidden').click(function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "/admin/report/classified/forbidden/" + id;
        ...
        $('.unforbidden').click(function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "/admin/report/classified/unforbidden/" + id;
        ...
        $('.locked').click(function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "/admin/report/classified/locked/" + id;
        ...
        $('.delete_account').click(function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "/admin/report/classified/delete/" + id;
        ...
        $('.restore_account').click(function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "/admin/report/classified/restore/" + id;
        ...
        $('.create-noti').click(async function (){
            ...
            const { value: formValues } = await Swal.fire({
                ...
                preConfirm: () => {
                    ...
                    $.ajax({
                        url: "{{route('admin.report.classified.create_noti')}}",
                        type:"POST",
                        data:{
                            id : id,
                            mail_title:title,
