...
@section('Title', 'Seo chuyên mục tin rao')
@section('Style')
...
<h4 class="text-center font-weight-bold mt-5 mb-4">SEO CHUYÊN MỤC TIN RAO</h4>

<form action="{{route('admin.seo.editclassified',[$category->id])}}" method="post" enctype="multipart/form-data">
    @csrf
