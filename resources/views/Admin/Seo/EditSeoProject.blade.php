...
@section('Title', 'Seo chuyên mục dự án')
@section('Style')
...
<h4 class="text-center font-weight-bold mt-5 mb-4">SEO CHUYÊN MỤC DỰ ÁN</h4>

<form action="{{route('admin.seo.editproject',[$category->id])}}" method="post" enctype="multipart/form-data">
    @csrf
