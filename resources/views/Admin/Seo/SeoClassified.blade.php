...
@section('Title', 'Quản lý seo | Tin rao')
@section('Style')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <h4 class="text-center text-bold mt-4" >SEO CHUYÊN MỤC TIN RAO</h4>
                                            ...
                                            <div>
                                                {{-- @if($check_role == 1  ||key_exists(2, $check_role)) --}}
                                                    <div class="float-left ml-2">
                                                        ...
                                                        <a href="{{route('admin.seo.editclassified',$item->id)}}"
                    ...
                    <div class="table-bottom d-flex align-items-center justify-content-between mb-4  pb-5">
                        <div class="text-left d-flex align-items-center">
                            ...
                            <div class="display d-flex align-items-center mr-4">
                                <span>Hiển thị:</span>
                                <form method="get" id="paginateform" action="{{route('admin.seo.listclassified')}}">
