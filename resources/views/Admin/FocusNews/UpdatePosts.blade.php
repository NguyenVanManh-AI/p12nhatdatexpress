...
@section('Content')
    <section>
        ...
        <h4 class="text-bold text-center m-3">SỬA BÀI VIẾT TIÊU ĐIỂM</h4>
        <form action="{{route('admin.focus.update',[$news->id,\Crypt::encryptString($news->created_by)])}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row m-0 px-2 pb-3">
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-2">
                    <div class="row">
                        <div class="col-12 pb-3">
                            ...
                            <input id="news_title" value="{{old('news_title') ?? $news->news_title}}" class="form-control" type="text" name="news_title" required>
                        ...
                        <div class="col-12">
                            ...
                            <input value="{{old('video_url') ?? $news->video_url}}" class="form-control" type="text" name="video_url" placeholder="Nhập đường dẫn video youtube">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-2">
                    ...
                    <textarea class="form-control" name="news_description" style="height: 117px !important">{{old('news_description') ?? $news->news_description}}</textarea>
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-2">
                    ...
                    <input value="{{old('meta_key') ?? $news->meta_key}}" class="seo form-control" id="meta_key" type="text" name="meta_key" placeholder="Nhập từ khóa ...">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-2">
                    <label>Tiêu đề <span class="required"></span></label>
                    <input  value="{{old('meta_title') ?? $news->meta_title}}" class="seo form-control meta_title" id="meta_title" type="text" name="meta_title" placeholder="Nhập tiêu đề ...">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-2">
                    ...
                    <input value="{{old('news_url') ?? $news->news_url}}" class="seo form-control meta_url" id="news_url" type="text" name="meta_url" placeholder="Nhập đường dẫn tĩnh ...">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-2">
                    ...
                    <input value="{{old('meta_desc') ?? $news->meta_desc}}" class="seo form-control" id="meta_desc" type="text" name="meta_desc" placeholder="Nhập mô tả ...">
