...
@section('Content')
    ...
    <h4 class="text-center font-weight-bold">THÙNG RÁC CHIẾN DỊCH EMAIL KHÁCH HÀNG</h4>
    <!-- Main content -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="table-responsive">
                        <form action="{{route('admin.email-campaign.un-delete-mail-campaign-list')}}" id="formtrash"
                              method="post">
                            @csrf
                                            ...
                                            <div>
                                                ...
                                                @if($check_role == 1  ||key_exists(6, $check_role))
                                                    <div class="float-left ml10">
                                                        ...
                                                        <a class="setting-item delete text-primary action_delete cusor-point"
                                                           data-id="{{$item->id}}"
                        ...
                        <div class="text-left d-flex box-panage align-items-center mt-3">
                            ...
                            <div>
                                ...
                                @if($check_role == 1  ||key_exists(4, $check_role))
                                    <a href="{{route('admin.contact.campaign.list')}}" class="btn btn-primary">
                                        Quay lại
                                    </a>
                                @endif
                            </div>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    {{-- truy cập link để xóa item --}}
                        window.location.href = "/admin/mail-campaign/campaign/un-delete-mail-campaign/" + id + "/" + created_by;
