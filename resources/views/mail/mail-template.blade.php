...
<table cellspacing="0" border="0" cellpadding="0" width="100%" bgcolor="#f2f3f8"
    ...
    <tr>
        <td>
            <table style="background-color: #f2f3f8;margin:0 auto;padding:3rem;" width="600px" border="0"
                ...
                <tr>
                    <td style="text-align:center;">
                        <a href="{{url('/')}}" title="logo" target="_blank">
                            <img src="{{asset(SystemConfig::logo())}}" class="logo" alt="Nhà đất express Logo" style="height: 100%; max-height: unset; width: unset">
                        </a>
                    </td>
                </tr> --}}
                <tr>
                    ...
                    <tr>
                        <td style="text-align:center;padding: 20px 0 10px">
                            <a href="{{ url('/') }}" title="Trang chủ">
                                <img src="{{ asset(SystemConfig::logo()) }}" class="logo" alt="Nhà đất express Logo" style="height: 50px;">
                            </a>
                        </td>
                    </tr>
                    <tr>
